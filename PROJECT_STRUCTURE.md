...
| `UPDATE_FLOW.md` | 自動更新、予告先発取得、PC同期の関係まとめ |
...
5. `update_today_probabilities.py` で今日の試合予定、勝率、予告先発を作る
6. `fetch_lineups_2026.py` でスタメンを作る
7. `fetch_standings_2026.py` で順位表を作る
8. `make_site.py` でサイトを作る
