...
<head>
  ...
  <style>
    :root {{
      ...
      --accent-dark: #9ae6ff;
      --gold: #f8c84b;
      --glow: rgba(66, 197, 255, 0.2);
      --panel-shadow: 0 24px 70px rgba(0, 0, 0, 0.28), inset 0 1px 0 rgba(255, 255, 255, 0.055);
    }}
    * {{ box-sizing: border-box; }}
    body {{
      ...
      background:
        radial-gradient(ellipse 60% 34% at 10% -8%, rgba(42, 152, 214, 0.23), transparent 70%),
        radial-gradient(ellipse 42% 25% at 95% 6%, rgba(248, 200, 75, 0.12), transparent 75%),
        linear-gradient(180deg, #101d31 0%, #08111e 30%, var(--bg) 72%, #04070d 100%);
      color: var(--ink);
      min-height: 100vh;
    }}
    header {{
      border-bottom: 1px solid rgba(154, 230, 255, 0.2);
    ...
    .tab.is-active {{
      background: linear-gradient(135deg, #0c8cc6, #145cb3);
      border-color: #72d8ff;
      color: #f8fdff;
      box-shadow: 0 8px 24px var(--glow), inset 0 1px 0 rgba(255, 255, 255, 0.24);
    }}
    .schedule-tabs {{
      display: flex;
      gap: 8px;
    ...
    .metric {{
      position: relative;
      background: linear-gradient(145deg, rgba(24, 40, 62, 0.98), rgba(9, 16, 27, 0.98));
      border: 1px solid var(--line);
      border-radius: 14px;
      padding: 16px 17px;
      min-height: 88px;
    ...
    .metric::before {{
      ...
      inset: 0 0 auto;
      height: 3px;
      background: linear-gradient(90deg, var(--gold), var(--accent), transparent 80%);
    }}
    .metric-label {{
      color: var(--muted);
      font-size: 12px;
    ...
    .panel {{
      background: linear-gradient(145deg, rgba(15, 27, 43, 0.96), rgba(7, 12, 21, 0.97));
      border: 1px solid var(--line);
      border-radius: 14px;
      overflow: hidden;
      box-shadow: var(--panel-shadow);
    ...
    .panel-header {{
      ...
      background: linear-gradient(90deg, rgba(28, 47, 72, 0.82), rgba(13, 23, 36, 0.58));
      display: flex;
      align-items: center;
      justify-content: space-between;
      gap: 12px;
